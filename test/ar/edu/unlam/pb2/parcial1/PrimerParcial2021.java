...
class PrimerParcial2021 {
	...
	public void queUnaPeliculaSeaVendible() {
		...
		// Validación
		assertEquals(PRECIO_VENTA, pelicula.precioDeVenta());
	}
	...
	public void queUnJuegoSeaAlquilable() {
		...
		// Validación
		assertEquals(PRECIO_ALQUILER, juego.precioDeAlquiler());
	}
	...
	public void queSeNoSePuedaVenderUnComestibleVendido() {
		// Preparación
		final Integer CODIGO_ESPERADO = 1;
		final String DESCRIPCION_ESPERADA = "Rhodesia";
		final String NOMBRE_VIDEOCLUB = "YPF";
		final Integer CODIGO_CLIENTE_ESPERADO = 1;
		final String NOMBRE_ESPERADO = "Ivan";
		final String APELLIDO_ESPERADO = "Maldonado";
		final Integer EDAD_ESPERADA = 20;
		final Estado ESTADO_INICIAL_ESPERADO = Estado.VENDIDO;
		final Estado ESTADO_FINAL_ESPERADO = Estado.VENDIDO;
		// Ejecución
		...
		// Validación
		assertEquals(ESTADO_INICIAL_ESPERADO, ypf.buscarProducto(comestible).getEstadoActual());
		assertFalse(ypf.vender(comestible, cliente));
		assertEquals(ESTADO_FINAL_ESPERADO, ypf.buscarProducto(comestible).getEstadoActual());
	...
	public void queSeNoSePuedaAlquilarUnJuegoAlquilado() {
		// Preparación
		final Integer CODIGO_ESPERADO = 1;
		final String DESCRIPCION_ESPERADA = "FIFA21";
		final TipoDeConsola CONSOLA_ESPERADA = TipoDeConsola.PLAY_STATION;
		final String NOMBRE_VIDEOCLUB = "YPF";
		final Integer CODIGO_CLIENTE_ESPERADO = 1;
		final String NOMBRE_ESPERADO = "Ivan";
		...
		// Validación
		assertEquals(ESTADO_INICIAL_ESPERADO, sony.buscarProducto(comestible).getEstadoActual());
		assertFalse(sony.alquilar(comestible, cliente));
		assertEquals(ESTADO_FINAL_ESPERADO, sony.buscarProducto(comestible).getEstadoActual());
	}
	...
	public void queSeNoSePuedaAlquilarUnPeliculaAUnMenor() {
		...
		final String NOMBRE_ESPERADO = "Camila";
		final String APELLIDO_ESPERADO = "Privado";
		final Integer EDAD_ESPERADA = 17;
		final Estado ESTADO_INICIAL_ESPERADO = Estado.DISPONIBLE;
